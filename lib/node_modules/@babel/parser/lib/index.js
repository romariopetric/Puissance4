...
const toNodeDescription = node => node.type === "UpdateExpression" ? NodeDescriptions.UpdateExpression["".concat(node.prefix)] : NodeDescriptions[node.type];
var StandardErrors = {
...
class LValParser extends NodeUtils {
  ...
  checkLVal(expression, ancestor) {
    let binding = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 64;
    let checkClashes = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    let strictModeChanged = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    let hasParenthesizedAncestor = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
...
class StatementParser extends ExpressionParser {
  ...
  parseProgram(program) {
    let end = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 140;
