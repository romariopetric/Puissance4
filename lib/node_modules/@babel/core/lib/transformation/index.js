...
function* run(config, code, ast) {
  ...
  try {
    ...
    var _opts$filename;
    e.message = "".concat((_opts$filename = opts.filename) != null ? _opts$filename : "unknown file", ": ").concat(e.message);
    if (!e.code) {
  ...
  try {
    ...
    var _opts$filename2;
    e.message = "".concat((_opts$filename2 = opts.filename) != null ? _opts$filename2 : "unknown file", ": ").concat(e.message);
    if (!e.code) {
